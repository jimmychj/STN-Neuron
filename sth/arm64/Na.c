...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 Na /Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/Na.mod\n");
 ...
 v=_v;
{
  ...
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file Na.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/Na.mod";
static const char* nmodl_file_text = 
