...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 sKCa /Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/sKCa.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  integrate();
 if(error){fprintf(stderr,"at line 70 in file sKCa.mod:\n	SOLVE integrate METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/sKCa.mod";
static const char* nmodl_file_text = 
