...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 HVA /Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/HVA.mod\n");
 ...
 v=_v;
{
  ...
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 80 in file HVA.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/HVA.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  ":::INCLUDE \"ghk.inc\"\n"
  ":::realpath /Users/jimmychen/Documents/PhD/ENBO_STN_arm/sth/ghk.inc\n"
  "\n"
  "\n"
